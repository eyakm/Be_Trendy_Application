  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomSheet: Container(
        color: darkMode ? BTColors.darkest : BTColors.white ,
        //color: Colors.white,
        ...
        child: isLastPage? getStarted() : Row(
          ...
          children: [
            ...
            TextButton(
                ...
                child: const Text("Skip", style: TextStyle(color: BTColors.primaryColor))),
            ...
            SmoothPageIndicator(
              ...
              effect: const WormEffect(
                dotHeight: 12,
                dotWidth: 12,
                activeDotColor: BTColors.buttonPrimary,
              ),
            ),
            ...
            TextButton(
                onPressed: ()=>pageController.nextPage(
                    duration: const Duration(milliseconds: 600), curve: Curves.easeIn),
                child: const Text("Next", style: TextStyle(color: BTColors.primaryColor))),
