...
// Assuming an 11-digit tunisian phone number format: (216) 22-456-789
  if (phoneNumber.length == 11) {
  return '(${phoneNumber.substring(0, 3)}) ${phoneNumber.substring(3, 5)} ${phoneNumber.substring(5)}';
  } else if (phoneNumber.length == 12) {
    return '(${phoneNumber.substring(0, 4)}) ${phoneNumber.substring(4, 7)} ${phoneNumber.substring(7)}';
  }
  // Add more custom phone number formatting logic for different formats if needed. return phoneNumber;
